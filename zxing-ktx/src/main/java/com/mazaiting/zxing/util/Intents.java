...
public final class Intents {
  ...
  public static final class Scan {
     ...
     * 只解码1 D 条形码 （目前有的 UPC EAN 39码 、 128码 ）。
     */
     ...
     * intent.getStringExtra(SCAN_RESULT_TEXT). If the user presses Back, the result code will be
     * RESULT_CANCELED.
     */
    public static final String RESULT = "SCAN_RESULT_TEXT";
