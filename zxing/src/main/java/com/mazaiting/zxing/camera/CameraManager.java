...
import com.mazaiting.zxing.camera.open.OpenCameraInterface;
...
public final class CameraManager {
   ...
   * 预览帧被传递到这里，我们传递给注册的处理程序
   * Make sure toclear the handler so it will only receive one message.
   * 确保清除处理程序只会收到一个消息
   */
   ...
   *               传入的这个是camera将要绘制的frames  holder类
...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
   ...
   *
   *一个建基于预览缓存格式适当的luminancesource对象的工厂方法，所描述的camera.parameters。
   *
